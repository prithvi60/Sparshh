      ...
      <div className="grid w-full h-full grid-cols-2 gap-4 py-5 sm:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-5 place-items-center">
        {reels.map((reel, idx) => (
          <div onClick={() => handleClick(reel)} key={idx}>
            <Card style={{backgroundColor: "#FDFCD4"}} className="overflow-hidden h-[17.5rem] md:h-[380px] lg:h-[460px] xl:h-[500px] w-40 md:w-full aspect-clip group cursor-pointer z-10 !shadow-none">
